...
[![AppVeyor build
status](https://ci.appveyor.com/api/projects/status/github/USCbiostats/partition?branch=master&svg=true)](https://ci.appveyor.com/project/USCbiostats/partition)
[![Coverage
